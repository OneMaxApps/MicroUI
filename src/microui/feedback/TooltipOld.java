...
public final class TooltipOld extends SpatialView {
	...
	public TooltipOld(InteractionHandler interactionHandle) {

		color = GlobalTooltipOld.DEFAULT_COLOR;
...
//				callback.resetInsideTimer();
	...
	public final Color getColor() {
		if(color == GlobalTooltipOld.DEFAULT_COLOR) {
			return color = new Color(GlobalTooltipOld.DEFAULT_COLOR);
		}
	...
	public final class Text extends TextController {
		...
		private final void draw() {
			ctx.pushStyle();
			colorText.apply();
			ctx.textSize(GlobalTooltipOld.DEFAULT_TEXT_SIZE);
