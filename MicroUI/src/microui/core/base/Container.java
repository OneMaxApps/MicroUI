...
//		setMinSize(100);
//		setMaxSize(ctx.width,ctx.height);
//		
//		color = new Color(0, 0, 128, 32);
//		margin = new Margin();
//		image = new Texture();
//		image.setBoundsProperty(this);
...
//	}
//
//	protected Color getMutableColor() {
//		return color;
//	}
//	
...
//		}
//
//		boolean isAutoCenterModeEnabled() {
//			return isAutoCenterModeEnabled;
//		}
//
//		void setAutoCenterModeEnabled(boolean setAutoCenterModeEnabled) {
